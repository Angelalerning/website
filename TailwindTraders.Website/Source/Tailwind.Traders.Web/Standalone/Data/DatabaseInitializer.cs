...
namespace Tailwind.Traders.Web.Standalone.Data {
  public class StandaloneDatabaseInitializer {
    ...
    public StandaloneDatabaseInitializer(ILogger logger,
    ...
    public async Task Seed() {
      ...
      if (await IsDatabaseEmpty(conn)) {
        ...
        await SeedTable(
            conn, "Brands",
            "https://raw.githubusercontent.com/microsoft/TailwindTraders-Backend/main/Source/Services/Tailwind.Traders.Product.Api/Setup/ProductBrands.csv");
        await CreateTypesTable(conn);
        await SeedTable(
            conn, "Types",
            "https://raw.githubusercontent.com/microsoft/TailwindTraders-Backend/main/Source/Services/Tailwind.Traders.Product.Api/Setup/ProductTypes.csv");
        await CreateTagsTable(conn);
        await SeedTable(
            conn, "Tags",
            "https://raw.githubusercontent.com/microsoft/TailwindTraders-Backend/main/Source/Services/Tailwind.Traders.Product.Api/Setup/ProductTags.csv");
        await CreateFeaturesTable(conn);
        await SeedTable(
            conn, "Features",
            "https://raw.githubusercontent.com/microsoft/TailwindTraders-Backend/main/Source/Services/Tailwind.Traders.Product.Api/Setup/ProductFeatures.csv");
        await CreateProductsTable(conn);
        await SeedTable(
            conn, "Products",
            "https://raw.githubusercontent.com/microsoft/TailwindTraders-Backend/main/Source/Services/Tailwind.Traders.Product.Api/Setup/ProductItems.csv");
    ...
    private async Task SeedTable(SqlConnection conn, string tableName,
                                 string csvUrl) {
      ...
      while (await csv.ReadAsync()) {
        ...
        foreach (var header in headers) {
          command.Parameters.AddWithValue("@" + header, csv.GetField(header));
        }
    ...
    public static void Initialize(ILogger logger,
      ...
      var initializer = new StandaloneDatabaseInitializer(
          logger, configuration["SqlConnectionString"]);
